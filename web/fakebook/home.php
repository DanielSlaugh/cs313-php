...
$query = 'SELECT u.username, u.password, u.display_name, m.message_text, m.message_time, FROM users u WHERE username=$fusername AND password=$user_password JOIN message m ON u.id = m.user_id';
$stmt = $db->prepare($query);
$stmt->execute();
